...
import type { IMessagingHubMediator } from "../AppMediator/Interfaces/IMessagingHubMediator";
import type { ISubscription } from "../AppState/MessagingHubState/Interfaces/ISupscription";
import type { IHubConnectionBuilder } from "./Interfaces/IHubconnectionBuilder";
import type { IHubProxy } from "./Interfaces/IHubProxy";
import type { MessageDetails } from "../AppState/MessagingHubState/Interfaces/MessageDetails";
import type { ConversationMessagesDetails } from "../AppState/MessagingHubState/Interfaces/ConversationMessagesDetails";
            ...
            try {
                await this.connection.start(['webSockets'])
                    ...
                    .fail((error: any = 'Cannot connect to the hub with this creditals') => {
                        ...
                        setTimeout(async () => await this.initHubConnection(), 30000);
                    })
            } catch (error) {
